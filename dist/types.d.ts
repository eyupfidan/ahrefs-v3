...
export type RequestMethod = <TResponse = unknown, TParams extends AhrefsParams = AhrefsParams, TBody = AhrefsBody>(options?: AhrefsRequestOptions<TParams, TBody>) => Promise<AhrefsResponse<TResponse>>;
